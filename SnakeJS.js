...
function advanceSnake() {
    ...
    const didEatBonusFood = snake[0].x === bonusX && snake[0].y === bonusY;
    if (didEatBonusFood) {
        // Increase score
        score += 20;
        // Display score on screen
...
/**
    ...
    */
function createFood() {
    setTimeout(createFood, 6000)
    timeout = setTimeout(createFood, 6000)
...
function createBonusFood() {
    ...
    // if the new food location is where the snake currently is, generate a new food location
    snake.forEach(function isFoodOnSnake(part) {
        const foodIsoNsnake = part.x == bonusX && part.y == bonusY;
